...
const iconCount = 100;
const icons = ICONS_100.map((icon) => icon.replace(/_/g, '-'));
</script>
  ...
  <div class="container">
    <header>
      ...
      <nav>
        ...
        <a href="https://github.com/kazudeath1/material-symbols-benchmark/blob/main/pages/iconify-ondemand-100.vue" target="_blank" rel="noopener noreferrer">View Source</a>
      </nav>
    </header>
    ...
    <main>
      <div class="info">
        ...
        <p>表示形式: <strong>@iconify/vue On Demand (&lt;Icon&gt; コンポーネント)</strong></p>
        <p>サイズ: 20px, 24px, 40px, 48px</p>
        <p class="note">※ SVGは固定サイズのため、optical size対応なし</p>
        <p class="note">※ 必要なアイコンのみオンデマンドで取得</p>
      </div>
